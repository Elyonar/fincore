...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE product.fee_rules TO product_app;

--
-- Name: TABLE limit_rules; Type: ACL; Schema: product; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE product.limit_rules TO product_app;

--
-- Name: TABLE product_versions; Type: ACL; Schema: product; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE product.product_versions TO product_app;

--
-- Name: TABLE products; Type: ACL; Schema: product; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE product.products TO product_app;

--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: product; Owner: -
--

ALTER DEFAULT PRIVILEGES FOR ROLE fincore IN SCHEMA product GRANT SELECT,USAGE ON SEQUENCES TO product_app;

--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: product; Owner: -
--

ALTER DEFAULT PRIVILEGES FOR ROLE fincore IN SCHEMA product GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES TO product_app;
