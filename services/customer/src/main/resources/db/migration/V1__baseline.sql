...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE customer.communication_consent TO customer_app;

--
-- Name: TABLE consent_changes; Type: ACL; Schema: customer; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE customer.consent_changes TO customer_app;

--
-- Name: TABLE customer_accounts; Type: ACL; Schema: customer; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE customer.customer_accounts TO customer_app;

--
-- Name: TABLE customer_tier_changes; Type: ACL; Schema: customer; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE customer.customer_tier_changes TO customer_app;

--
-- Name: TABLE customers; Type: ACL; Schema: customer; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE customer.customers TO customer_app;

--
-- Name: TABLE numbering; Type: ACL; Schema: customer; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE customer.numbering TO customer_app;

--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: customer; Owner: -
--

ALTER DEFAULT PRIVILEGES FOR ROLE fincore IN SCHEMA customer GRANT SELECT,USAGE ON SEQUENCES TO customer_app;

--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: customer; Owner: -
--

ALTER DEFAULT PRIVILEGES FOR ROLE fincore IN SCHEMA customer GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES TO customer_app;
