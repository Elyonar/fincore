...
**Status: design AGREED v2.1 — implemented, pre-1.0.** Packaging is decided
...
|---|---|---|
| The design at a glance + the decision log | [`docs/design.md`](docs/design.md) | AGREED v2.1 |
| **The three-valued outcome model** — the thing this service exists to get right | [`docs/outcome-protocol.md`](docs/outcome-protocol.md) | AGREED v2.1 |
| How sagas execute, recover, and are claimed across instances | [`docs/saga-protocol.md`](docs/saga-protocol.md) | AGREED v2.1 |
| Modules, boundaries, the ledger client, events, DR posture | [`docs/architecture.md`](docs/architecture.md) | AGREED v2.1 |
| Tables per schema, ownership rules, decided edge cases | [`docs/data-model.md`](docs/data-model.md) | AGREED v2.1 |
| Endpoint surface, error catalog, contract properties | [`docs/api.md`](docs/api.md) | AGREED v2.1 |
| Core's eight invariants and every test suite | [`docs/testing.md`](docs/testing.md) | AGREED v2.1 |
| **The UI runway** — identity end-to-end, the edge, ledger-read proxying, the Phase 0 read audit | [`docs/ui-runway.md`](docs/ui-runway.md) | AGREED v2.1 |
| **The administration surface** — product authoring, account opening, users and roles | [`docs/admin-surface.md`](docs/admin-surface.md) | AGREED v2.1 |
